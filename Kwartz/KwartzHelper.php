...
class KwartzHelper {
    ...
    /**
     *  comiple template with compareing timestamps
     */
    function compile_template($pdata_filename, $plogic_filename, $output_filename, $flag_escape, $lang='php', $toppings=NULL) {
