...
define('KWARTZ_PROPERTY_ODD'     , "'odd'");  // odd value for FOREACH/LOOP directive
define('KWARTZ_PROPERTY_EVEN'    , "'even'"); // even value for FOREACH/LOOP directive
define('KWARTZ_PROPERTY_JSTL'    , 1.2);      // 1.1 or 1.2
